...
@section('content')
    <form id="gerar-relatorio" method="post" action="/gerar-relatorio-oficiais/" class="form form-group" target="_blank">
        {{csrf_field()}}
        <div class="row">
            <div class="form-group col-md-7">
                <h4><label for="">SELECIONE A LOCALIDADE ONDE DESEJA LISTAR OS OFICIAIS: (RELATÓRIO DE MEMBROS COM OFÍCIOS)</label></h4>
